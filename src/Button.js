...
export const Button = ({
	...
	return (
		<Touchable
			...
			className={c('btn', className, (disabled || loading) && 'disabled', presentation && `btn-${presentation}`, fullWidth && 'full-width', active && 'active', color && `btn-${color}`, muted && 'muted', square && 'square')}
			onClick={e => {
